...
namespace ConcertBooking.WebHost.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public ConcertsController(IConcertRepo concertRepo, IVenueRepo venueRepo,
                                  IArtistRepo artistRepo, IUtilityRepo utilityRepo,
        ...
        public async Task<IActionResult> Edit(EditConcertViewModel vm)
        {
            ...
            {
                concert.ImageUrl = await _utilityRepo.EditImage(containerName, 
                                            vm.ChooseImage, concert.ImageUrl);
            }
        ...
        public async Task<IActionResult> GetTickets(int id)
        {
            ...
            var vm = bookings.Select(b => new DashboardVieweModel
            {
